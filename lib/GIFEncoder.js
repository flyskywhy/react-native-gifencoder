...
class GIFEncoder {
	...
	encode() {
		...
		for (const rgbaPixels of this.frames) {
			const rgbPixels = rgbaPixelsToRgbPixels(rgbaPixels);
			const analysisResult = this.analyzePixels(rgbPixels, this.sample);
			...
			if (this.transparent !== null) {
				transparentColorIndex = this.findClosestColorIndex(localColorTable, this.transparent, this.usedEntry);
			}
			...
			console.log(localColorTable.length, lctSize);
